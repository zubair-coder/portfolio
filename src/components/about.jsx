                ...
                >
                  <div className="col-md-12">
                    <div className="about-desc">
                      ...
                      <p>
                        I am a computer grad student from Pafkiet.I love
              ...
              <div className="col-md-4 text-center animate-box">
                <div className="services color-5">
                  ...
                  <div className="desc">
                    <h3>Dev Ops</h3>
                    <p>
                      I am pursuing my Passion towards Devops with Learning
                      through some mediums like through some videos or udemy
                      courses
                    </p>
                  </div>
                </div>
